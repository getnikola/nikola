...
setup(name='Nikola',
      ...
      packages=['nikola',
                ...
                'nikola.extra_plugins',
                'nikola.extra_plugins.command_planetoid',
                'nikola.extra_plugins.compile_ipynb',
                'nikola.extra_plugins.task_localsearch',
                'nikola.extra_plugins.task_mustache',
                ],
      scripts=scripts,
