...
Obsolescence
    ...
    Python 3.10 or newer under Linux, Windows, or macOS and can find a server
...
You can find documentation for all extensions in `python-markdown's docs <https://python-markdown.github.io/extensions/>`_.
