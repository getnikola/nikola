...
There are not so many themes for Nikola. They are available at http://themes.getnikola.com
Nikola has a builtin theme download/install mechanism to install those themes, its
